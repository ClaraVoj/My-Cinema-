...
// Returns the private 'App\Repository\DistribRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DistribRepository.php';

return $this->privates['App\\Repository\\DistribRepository'] = new \App\Repository\DistribRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
