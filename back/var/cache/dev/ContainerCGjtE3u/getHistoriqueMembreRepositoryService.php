...
// Returns the private 'App\Repository\HistoriqueMembreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HistoriqueMembreRepository.php';

return $this->privates['App\\Repository\\HistoriqueMembreRepository'] = new \App\Repository\HistoriqueMembreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
