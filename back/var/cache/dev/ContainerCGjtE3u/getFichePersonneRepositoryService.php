...
// Returns the private 'App\Repository\FichePersonneRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FichePersonneRepository.php';

return $this->privates['App\\Repository\\FichePersonneRepository'] = new \App\Repository\FichePersonneRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
